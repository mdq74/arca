...
public class InvoiceValidationResult {
    ...
    public LocalDate getCaeExpiration() { return caeExpiration; }
    public void setCaeExpiration(LocalDate caeExpiration) { this.caeExpiration = caeExpiration; }
    public String getMessage() { return message; }
    public void setMessage(String message) { this.message = message; }
    public String getEmisorCuit() { return emisorCuit; }
    public void setEmisorCuit(String emisorCuit) { this.emisorCuit = emisorCuit; }
    ...
    public int getNumeroComprobante() { return numeroComprobante; }
    public void setNumeroComprobante(int numeroComprobante) { this.numeroComprobante = numeroComprobante; }
}
